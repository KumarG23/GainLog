...
export function FoundationScreen() {
  ...
  const saveFocus = async (value: Focus | null) => { try { await journey.savePreferences({ focus: value }); setFocusOpen(false); } catch (e) { setError(e instanceof Error ? e.message : 'Focus not saved.'); } };
