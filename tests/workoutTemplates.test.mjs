...
test('optimizer uses a machine-step instruction instead of inventing an unsupported increment', () => {
  const history = [
    workout('older-push', '2026-07-27T06:00:00-04:00', 'Machine Chest Press', [
      { id: 'o1', weight: 50, reps: 10 },
      { id: 'o2', weight: 50, reps: 9 },
      { id: 'o3', weight: 50, reps: 8 },
    ]),
...
test('optimizer counts duplicate same-name entries as one prior session', () => {
  ...
  const history = [
    workout('baseline', '2026-07-27T06:00:00-04:00', 'Machine Chest Press', [
      { id: 'b1', weight: 75, reps: 10 },
      { id: 'b2', weight: 75, reps: 10 },
      { id: 'b3', weight: 75, reps: 10 },
  ...
  const duplicateIdHistory = [
    workout('baseline-id', '2026-07-20T06:00:00-04:00', 'Machine Chest Press', [
      { id: 'id-b1', weight: 75, reps: 10 },
      { id: 'id-b2', weight: 75, reps: 10 },
      { id: 'id-b3', weight: 75, reps: 10 },
    ], { effort: 'right', notes: 'Clean baseline.' }),
    workout('same-session', '2026-07-27T06:00:00-04:00', 'Machine Chest Press', completeSets('same-a'), {
      effort: 'right', notes: 'Clean controlled reps.',
    }),
    workout('same-session', '2026-08-03T06:00:00-04:00', 'Machine Chest Press', completeSets('same-b'), {
...
test('optimizer increases only with complete workout feedback and safe notes', () => {
  ...
  const cleanFeedback = [
    ...
    workout('older', '2026-07-27T06:00:00-04:00', 'Machine Chest Press', topSets('o'), {
      effort: 'right',
      notes: 'Clean form with a couple reps left.',
    }),
    workout('latest', '2026-08-03T06:00:00-04:00', 'Machine Chest Press', topSets('l'), {
      effort: 'easy',
